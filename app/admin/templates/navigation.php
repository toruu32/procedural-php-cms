    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#posts"><i class="fa fa-fw fa-print"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                ...
                <li>
                    <a href="#"><i class="fa fa-fw fa-table"></i> Categories</a>
                </li>
                <li>
